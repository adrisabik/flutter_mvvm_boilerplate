...
abstract class $ConnectivityStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isConnected, ConnectivityType type, bool isInitialized});
}
...
class _$ConnectivityStateImpl implements _ConnectivityState {
  const _$ConnectivityStateImpl({
    ...
    this.type = ConnectivityType.unknown,
  ...
  @override
  String toString() {
    return 'ConnectivityState(isConnected: $isConnected, type: $type, isInitialized: $isInitialized)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isConnected, type, isInitialized);
